...
class ResBlock2(nn.Module):
    def __init__(self,in_channel,middle_channle,out_channel,stride=1):
        ...
        self.layer = nn.Sequential(
            ...
            nn.LeakyReLU(),
            nn.Conv2d(in_channels=middle_channle,out_channels=middle_channle,kernel_size=3,stride=stride,padding=1),
            nn.BatchNorm2d(middle_channle),
            nn.LeakyReLU(),
...
class MyNet(nn.Module):
    def __init__(self,  image_width = image_width, image_height = image_height):
        ...
        self.conv2_1 = ResBlock1(in_channel=32, out_channel=32, stride=1)
        self.conv2_2 = ResBlock1(in_channel=32, out_channel=64, stride=2)
        self.conv2_3 = ResBlock1(in_channel=64, out_channel=64, stride=1)
        self.conv3_1 = ResBlock1(in_channel=64, out_channel=128, stride=2)
        self.conv3_2 = ResBlock1(in_channel=128, out_channel=128, stride=1)
        self.conv3_3 = ResBlock1(in_channel=128, out_channel=128, stride=2)
        self.conv3_4 = ResBlock1(in_channel=128, out_channel=128, stride=2)
        # self.conv4_1 = ResBlock1(in_channel=128, out_channel=256, stride=2)
        # self.conv4_2 = ResBlock1(in_channel=256, out_channel=256, stride=1)
        # self.conv4_3 = ResBlock1(in_channel=256, out_channel=256, stride=1)
        # self.conv4_4 = ResBlock1(in_channel=256, out_channel=256, stride=1)
        # self.conv4_5 = ResBlock1(in_channel=256, out_channel=256, stride=1)
        # self.conv4_6 = ResBlock1(in_channel=256, out_channel=256, stride=1)
        # self.conv5_1 = ResBlock1(in_channel=256, out_channel=512, stride=2)
        # self.conv5_2 = ResBlock1(in_channel=512, out_channel=512, stride=1)
        # self.conv5_3 = ResBlock1(in_channel=512, out_channel=512, stride=1)

        self.fc = nn.Sequential(
            nn.Linear(in_features=3*3*128, out_features=64*64, bias=True), # 64 in_features=8*8*256
            nn.Dropout(0.2),  # drop 50% of the neuron
            nn.LeakyReLU(),
...
if __name__ == "__main__":
    ...
    modelpath = './model/model_40_res_1.ckpt'
    loss_path = './loss/loss_40_res_1.csv'
    Save_path = './save_data/save_data_40_res_1.csv'
    Val_path = './save_data/val_data_40_res_1.csv'
