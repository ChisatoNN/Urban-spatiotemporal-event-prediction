...
class MyNet(nn.Module):
    def __init__(self,  image_width = image_width, image_height = image_height):
        ...
        self.layer1 = nn.Sequential(  
            nn.Conv2d(3, 32, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1),dilation=(2, 2)),
            nn.BatchNorm2d(32),
        ...
        self.layer2 = nn.Sequential(
            nn.Conv2d(32, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1),dilation=(2, 2)),
            nn.BatchNorm2d(64),
        ...
        self.layer3 = nn.Sequential(
            nn.Conv2d(64, 128, kernel_size=(5, 5), stride=(1, 1), padding=(1, 1),dilation=(2, 2)),
            nn.BatchNorm2d(128),
            nn.Dropout(0.5),  # drop 50% of the neuron
            nn.LeakyReLU(inplace=True),
            # nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        ...
        self.layer4 = nn.Sequential(
            nn.Conv2d(128, 128, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1),dilation=(2, 2)),
            nn.BatchNorm2d(128),
            nn.Dropout(0.5),  # drop 50% of the neuron
            nn.LeakyReLU(inplace=True),
            # nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        ...
        self.layer5 = nn.Sequential(
            nn.Conv2d(128, 256, kernel_size=(2, 2), stride=(1, 1), padding=(1, 1), dilation=(2, 2)),
            nn.BatchNorm2d(256),
            nn.Dropout(0.2),  # drop 50% of the neuron
            nn.LeakyReLU(inplace=True),
        ...
        self.fc = nn.Sequential(
            nn.Linear(in_features=6*6*128, out_features=64*64, bias=True), 
            nn.Dropout(0.2),  # drop 50% of the neuron
            nn.LeakyReLU(),
...
if __name__ == "__main__":
    ...
    modelpath = './model/model_oNAdam.ckpt'
