...
if __name__ == "__main__":
    ...
    path1 = './feature(50)/'  # picture-48
    train_x, train_y, target_name = read_picture(path1)
    modelpath = './model/model_50_2.ckpt'
    loss_path = './loss/loss_50_2.csv'
    Save_path = './save_data/save_data_50_2.csv'
    Val_path = './save_data/val_data_50_2.csv'
