...
class MyNet(nn.Module):
    def __init__(self, class_number = class_number, image_width = image_width, image_height = image_height):
        ...
        self.fc = nn.Sequential(
            nn.Linear(in_features=32*20*20, out_features=64*64, bias=True), # 64 in_features=8*8*256
            nn.Dropout(0.2),  # drop 50% of the neuron
            nn.LeakyReLU(),
...
if __name__ == "__main__":
    ...
    modelpath = './model/model_20_1_layer.ckpt'
    loss_path = './loss/loss_20_1_layer.csv'
    Save_path = './save_data/save_data_20_1_layer.csv'
    Val_path = './save_data/val_data_20_1_layer.csv'
    predict_path = './CNN_20_1/' 
